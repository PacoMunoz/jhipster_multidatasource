package es.deutz.demo.repository;

import es.deutz.demo.MultidatasourcesApp;
import es.deutz.demo.config.Constants;
import es.deutz.demo.config.audit.AuditEventConverter;
import es.deutz.demo.domain.PersistentAuditEvent;
...
import static es.deutz.demo.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
