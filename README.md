...
This is a example of how to start jhipster with two diferent datasources.
...
To build the final jar and optimize the multidatasources application for production, run:
